...
- **Phase B.2 — the interactive `minerva:lint` skill.** Builds on the deterministic
  detector ([[018-decision-phase-b-deterministic-lint-detector]]): a read-mostly
  ...
  **gated fixes** (index repair, missing-reciprocal insertion, supersession banners)
  respecting [[016-constraint-promote-narrowed-never-overwrite]]. Per
  [[013-decision-behavioral-evals-provisional]] the LLM-judged output stays
