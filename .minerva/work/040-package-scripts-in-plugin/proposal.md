...
**4. Update knowledge entry [[021-constraint-skill-wraps-script-via-importable-api]]** to reflect that scripts are now in the plugin directory as the primary source; repo `scripts/` holds development symlinks.
...
6. [[021-constraint-skill-wraps-script-via-importable-api]] knowledge entry updated.
