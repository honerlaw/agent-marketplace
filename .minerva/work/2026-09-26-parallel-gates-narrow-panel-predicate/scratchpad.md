...
- [rechecked — clean] scope check: fold-audit confirmed items 1–5 addressed; one low new concern (the 18–42 min merge-wait figure is from run_trace output the auditor could not reproduce) — not load-bearing, figure is from this session's trace
