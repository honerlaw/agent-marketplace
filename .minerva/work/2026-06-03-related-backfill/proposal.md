...
([[2026-06-02-constraint-knowledge-cross-reference-convention]]); the wiki's navigability
([[2026-06-02-decision-knowledge-wiki-navigability-layer]]) depends on edges. `minerva:migrate`
...
3. **Forward writes ONLY via `knowledge_edits.add_related_link`** — never freehand Edit
   ([[2026-06-02-constraint-promote-narrowed-never-overwrite]]-safety is a property of the
