...
skills must call tools, not narrate ([[2026-05-19-constraint-skills-must-call-tools-not-prose]]),
and handoffs must ride an observable inline argument
([[2026-06-07-decision-phase-handoff-rides-observable-intake]]) — yet ambient and
...
[[2026-06-06-pattern-rejected-alternative-reinvented-at-runtime]] (prose-only
