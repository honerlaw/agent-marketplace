...
| C7 | Stale roadmap content | lint "Phase B.3" ×4 (fixer shipped as lint-fix), migrate "future unit" ×4, quick's 3-rung ladder + escape missing balanced ×3 files | med | prose | **applied** |
