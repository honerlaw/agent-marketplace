...
Phase B.1 ([[2026-06-02-decision-phase-b-deterministic-lint-detector]]) shipped the
...
mutation risk seam ([[2026-06-02-constraint-promote-narrowed-never-overwrite]] /
[[2026-06-02-constraint-knowledge-span-model-single-sourced]]) and
[[2026-05-31-decision-behavioral-evals-provisional]] — the judged dimensions are
...
([[2026-05-31-decision-behavioral-evals-provisional]]), and framed **"spot-checked, not
...
- Tools are named explicitly per [[2026-05-19-constraint-skills-must-call-tools-not-prose]]
  (Bash for the detector invocation; Read/Grep/Glob for the corpus read).

### Catalog + contract + docs

- **Catalog ([[2026-05-21-constraint-minerva-skill-catalog-sync]]):** add `minerva:lint`
...
- **Phase B.3 — the gated, span-confined, idempotent fix-applier** (index repair +
  reciprocal insertion respecting [[2026-06-02-constraint-promote-narrowed-never-overwrite]]).
  It will import span constants from `scripts/knowledge_spans.py`
  ([[2026-06-02-constraint-knowledge-span-model-single-sourced]]) and will **amend** (not
