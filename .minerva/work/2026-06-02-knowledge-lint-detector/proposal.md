...
separate, provisional one) and honoring [[2026-05-31-decision-behavioral-evals-provisional]]
...
- delivers the knowledge-side of the drift-prevention automation
  [[2026-05-21-constraint-minerva-skill-catalog-sync]] deferred;
- honors [[2026-06-02-decision-knowledge-wiki-navigability-layer]]'s directive that tooling
...
[[2026-06-02-decision-knowledge-wiki-navigability-layer]]) — index problems are reported as
...
1. **Index drift**
   ...
   - **NNN-keyed bijection** between catalog lines and entry files: an entry file
     ...
     is cosmetic (per [[2026-06-02-constraint-knowledge-cross-reference-convention]]) — a
...
them. This keeps the span model single-sourced ([[2026-06-02-constraint-promote-narrowed-never-overwrite]]
...
**No new skill** → constraints [[2026-05-21-constraint-minerva-skill-catalog-sync]] (catalog
sync) and [[2026-05-31-constraint-skill-structural-contracts]] (`contract.json`) do not fire.
The gate runs only deterministic checks, honoring [[2026-05-31-decision-behavioral-evals-provisional]].
...
- The `minerva:lint` **skill** (Phase B.2): LLM-judged contradiction & staleness
  ...
  [[2026-06-02-constraint-promote-narrowed-never-overwrite]]). Recorded as a followup.
