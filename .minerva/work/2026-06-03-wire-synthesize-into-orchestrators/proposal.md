...
> deferred orchestrator wiring named in [[2026-06-03-decision-synthesis-layer-separate-file-advisory]].
...
- **PR boundary:** synthesize writes `overview.md` to repo-root `.minerva/knowledge/`
  ...
  *requested*, not guaranteed (advisory — acceptable per
  [[2026-06-03-decision-synthesis-layer-separate-file-advisory]] / 013).
...
- **Knowledge (016):** entry 024's body is **not** edited; a new entry 025 records the
  wiring and carries `builds on [[2026-06-03-decision-synthesis-layer-separate-file-advisory]]`
...
- CI-gating the overview's content (advisory per 013 /
  [[2026-06-03-decision-synthesis-layer-separate-file-advisory]]).
