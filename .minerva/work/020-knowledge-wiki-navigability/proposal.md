...
in knowledge entry [[011-decision-minerva-reference-tier]] (unit 014:
...
- **Routing template (Step 3):** mention `.minerva/knowledge/index.md` (the catalog
  ...
  [[001-decision-init-routing-detection-accepts-old-and-new-names]] is preserved.)
...
- **Catalog surfaces ([[010-constraint-minerva-skill-catalog-sync]]):** this unit
...
- **Contracts ([[012-constraint-skill-structural-contracts]]):** add load-bearing
