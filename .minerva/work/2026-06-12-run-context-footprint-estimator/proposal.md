...
- An importable-API test pins the cost math (synthetic `usage` → expected USD) and the sidechain/tool attribution against a fixture transcript; if CI-wired, appended to the enumerated pytest list per [[2026-06-11-constraint-ci-test-enumeration-explicit]].
