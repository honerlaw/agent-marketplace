...
- No CI wiring needed: the module is already in the workflow's enumerated list ([[2026-06-11-constraint-ci-test-enumeration-explicit]] satisfied by construction — verified, not assumed).
