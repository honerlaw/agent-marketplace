...
[[001-decision-init-routing-detection-accepts-old-and-new-names]]) never revisits an
...
**Detection arithmetic** (keeps [[001-decision-init-routing-detection-accepts-old-and-new-names]]
...
ever scaffolded ([[024-decision-synthesis-layer-separate-file-advisory]]: synthesize owns
...
- **Out of scope list:** the "`--refresh` mode … out of scope for v1" bullet is deleted
  ...
  hardening)".
- **Contract ([[012-constraint-skill-structural-contracts]]):** `evals/init/contract.json`
