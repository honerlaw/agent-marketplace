...
- [synthesis] no-op (1 un-synthesized [026] below threshold; overview current through 025) — dogfooding the unit-025 Phase-4.5 self-gate: a single new entry correctly does not warrant a re-synthesis.
