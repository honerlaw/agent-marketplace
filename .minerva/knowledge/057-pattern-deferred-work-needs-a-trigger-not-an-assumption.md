...
**Date**: 2026-08-07
**Type**: pattern
**Context**: .minerva/work/050-reconcile-never-strands-entries
...
- [[052-decision-promote-add-only-reconcile-on-default]] — the design this gap lived inside, which is otherwise sound and unchanged
- [[056-pattern-read-then-act-is-not-a-lock]] — the sibling hazard in the same step: that one is about two runs racing, this one about no second run existing
- [[055-constraint-knowledge-allocation-scans-across-branches]] — the allocation half of the same concurrency story
