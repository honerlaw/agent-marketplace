...
**Date**: 2026-06-03
**Type**: decision
**Context**: .minerva/work/029-init-routing-wiki-protocol (see git history if the worktree has been cleaned up)
...
deliberately-lenient detection ([[001-decision-init-routing-detection-accepts-old-and-new-names]])
...
- init never scaffolds an `overview.md` stub ([[024-decision-synthesis-layer-separate-file-advisory]]:
  synthesize owns that file); the template's parenthetical handles the fresh-scaffold gap.

## Related
- [[001-decision-init-routing-detection-accepts-old-and-new-names]] — builds on
