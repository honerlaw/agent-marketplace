...
that [[016-constraint-promote-narrowed-never-overwrite]] designates as the spec of
...
silently breaks the guarantee in [[016-constraint-promote-narrowed-never-overwrite]]
