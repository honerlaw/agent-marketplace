...
- **Adding a minerva skill now means four catalog updates** in the same change: the three from [[2026-05-21-constraint-minerva-skill-catalog-sync]] plus an entry in `site/index.html` between the pinned markers. The site is the only one of the four whose omission fails CI in both directions.
