...
- This constraint complements [[2026-05-19-constraint-plugin-skills-auto-discovered-from-directory]]: auto-discovery applies **inside** a plugin (skills), not **between** plugins (marketplace registry).

## Related
- [[2026-05-19-constraint-plugin-skills-auto-discovered-from-directory]] — see also
- [[2026-05-21-constraint-minerva-skill-catalog-sync]] — see also
- [[2026-06-10-pattern-plugin-discovery-mostly-auto-crawl]] — see also
