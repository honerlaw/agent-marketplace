...
Phase C of the LLM-wiki effort ([[2026-06-02-decision-knowledge-wiki-navigability-layer]]) adds
...
**The overview's content is advisory — never CI-gated** ([[2026-05-31-decision-behavioral-evals-provisional]]).
...
- Keep synthesis confined to the `overview.md` file. A future synthesis that **rewrites
  entry bodies** would reintroduce the [[2026-06-02-constraint-promote-narrowed-never-overwrite]]
...
- The synthesis tooling is an edge-deriving reader, so it obeys
  [[2026-06-03-constraint-wiki-edge-derivation-fence-aware]]: `synthesis_status.py` reuses the
...
- [[2026-05-31-decision-behavioral-evals-provisional]] — see also
- [[2026-06-03-constraint-wiki-edge-derivation-fence-aware]] — see also
- [[2026-06-03-decision-synthesize-wired-post-promote-self-gating]] — see also
