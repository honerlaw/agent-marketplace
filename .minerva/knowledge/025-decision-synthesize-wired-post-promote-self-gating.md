...
**Date**: 2026-06-03
**Type**: decision
**Context**: .minerva/work/025-wire-synthesize-into-orchestrators (see git history if the worktree has been cleaned up)
...
([[024-decision-synthesis-layer-separate-file-advisory]]). The user asked to wire it into
...
- Auto-mode commits a refreshed `overview.md` with no human review; this is acceptable
  ...
  ([[024-decision-synthesis-layer-separate-file-advisory]] / 013) — a bad link degrades
