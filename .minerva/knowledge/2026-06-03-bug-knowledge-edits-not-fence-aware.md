...
- `_related_has_target` flipped `in_related` at the fenced header, so prose `[[…]]`
  ...
  [[2026-06-03-constraint-wiki-edge-derivation-fence-aware]] warns about.
...
[[2026-06-02-constraint-knowledge-span-model-single-sourced]]) makes header **location**
...
## Related
- [[2026-06-03-constraint-wiki-edge-derivation-fence-aware]] — builds on
