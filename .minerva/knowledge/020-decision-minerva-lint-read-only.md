...
[[018-decision-phase-b-deterministic-lint-detector]] recorded the first Phase-B cut —
...
span invariant in [[016-constraint-promote-narrowed-never-overwrite]] and the span
module in [[019-constraint-knowledge-span-model-single-sourced]]. Per
[[013-decision-behavioral-evals-provisional]] the judged dimensions are provisional
...
- **Read-only is enforced by declaration, not by the contract floor.** The skill's
  ...
  ([[012-constraint-skill-structural-contracts]]) can only *witness* this via
...
- B.3 (the gated fix-applier) is the remaining Phase-B work; it consumes the same
  frozen detector and the [[019-constraint-knowledge-span-model-single-sourced]]
  span module.
